...
<div class="breadcrumb-area mb-30">
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="product-large-slider mb-20">
                        ...
                        @if (count($product->product_images) <= 3 )
                            @foreach ($product->product_images  as $image)
                            <div class="pro-large-img">
                                <img src="{{ Storage::url($image->img) }}" alt="" />
                                <div class="img-view">
                                    <a class="img-popup" href="{{ Storage::url($image->img) }}"><i class="fa fa-search"></i></a>
                                </div>
                            </div>
                            @endforeach
                        @endif
                        ...
                        <div class="product-details-contentt">
                            ...
                            <div class="pro-quantity-box mb-30">
                                <div class="qty-boxx">{{-- 
                                    ...
                                    <button class="btn-cart lg-btn add-to-cart" data-link="{{ route('add-cart', $product->id) }}">в корзину</button>
                                </div>
                            </div>
                            <div class="useful-links mb-20">
                                <ul>
                                    <li>
                                        <a href="#" class="add-to-cart" data-link={{ route('wishlist-add', $product->id) }}><i class="fa fa-heart-o"></i>Добавить в избранное</a>
                                    </li>
                            {{--         <li>
                ...
                <div class="col-lg-12">
                    <div class="product-info mt-half">
                        <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="nav_desctiption" data-toggle="pill" href="#tab_description" role="tab" aria-controls="tab_description" aria-selected="true">Описание к продукту</a>
                            </li>
                            {{-- <li class="nav-item">
    ...
    @if (count($product->category->products) != 0 )
    <div class="related-product-area mb-40">
        <div class="container-fluid">
            <div class="section-title">
                <h3><span>Похожие</span> продукты </h3>
            </div>
            <div class="flash-sale-active4 owl-carousel owl-arrow-style">
                @foreach ($product->category->products as $category_product)
                @if ($category_product->id == $product->id)    
                @else
                <div class="product-item mb-30">
                    <div class="product-thumb">
                        <a href="{{ route('product', [$category_product->category->code, $category_product->code]) }}">
                            <img src="{{ Storage::url($category_product->img) }}" class="pri-img" alt="">
                            <img src="{{ Storage::url($category_product->img) }}" class="sec-img" alt="">
                        </a>
                        {{-- <div class="box-label">
                    ...
                    <div class="product-caption">
                        <div class="manufacture-product">
                            <p><a href="#">{{ $category_product->brand->name }}</a></p>
                        </div>
                        <div class="product-name">
                            <h4><a href="{{ route('product', [$category_product->category->code, $category_product->code]) }}">{{ $category_product->name }}</a></h4>
                        </div>
                        {{-- <div class="ratings">
                        ...
                        <div class="price-box">
                            <span class="regular-price"><span class="special-price">{{ $category_product->price }} $</span></span>
                            {{-- <span class="old-price"><del>£90.00</del></span> --}}
                        </div>
                        <button class="btn-cart add-to-cart" type="button">В корзину</button>
                    </div>
                </div>  
                @endif
